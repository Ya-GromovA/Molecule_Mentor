...
source.include_exts = py,kv,png,jpg,jpeg,json,pdb,txt,md,ttf,otf,so,bin

source.include_patterns = assets/**,kv/**,screens/**,utils/**,data/**,theme.py,main.py
; Исключаем папку с моделями из Lite версии
source.exclude_patterns = **/*.bak,**/*.tmp,bin/**,.buildozer/**,venv/**,__pycache__/**,.git/**,assets/models/**
